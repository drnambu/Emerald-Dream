...
#define I_USE_EVO_HELD_ITEMS_FROM_BAG   TRUE       // BUBBA: turned on.If TRUE, items such as Razor Claw or Electirizer will be usable from the bag to evolve a Pokémon just like in LA.
...
// TM config
#define I_REUSABLE_TMS          TRUE       // BUBBA: turned on.In Gen5-8, TMs are reusable. Setting this to TRUE will make all vanilla TMs reusable, though they can also be cherry-picked by setting their importance to 1.
