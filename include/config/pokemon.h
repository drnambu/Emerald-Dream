...
#define P_LEARNSET_HELPER_TEACHABLE      FALSE   //BUBBA: turned off.  If TRUE, teachable_learnsets.h will be populated by tools/learnset_helpers/make_teachables.py using the included JSON files based on available TMs and tutors.
