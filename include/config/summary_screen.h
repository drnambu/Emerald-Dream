...
// IV/EV settings
#define P_SUMMARY_SCREEN_IV_EV_INFO      TRUE  //BUBBA: turned on. If TRUE, will allow player to cycle through the Stats, IVs, and EVs in the summary screen skills page.
...
#define P_SUMMARY_SCREEN_IV_EV_VALUES    TRUE  //BUBBA: turned on. If TRUE, will show the actual IV value instead of the letter grade.
/*
LETTER GRADE GUIDE:
...
#define P_ENABLE_MOVE_RELEARNERS         TRUE   //BUBBA: turned on. If TRUE, it enables move relearners for egg, TM and tutor. (see below for specific configs /flags)
#define P_SORT_MOVES                     TRUE   //BUBBA: turned on. If TRUE, sorts all moves alphabetically in the relearner's list.
