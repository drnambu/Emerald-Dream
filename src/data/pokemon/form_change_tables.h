...
{
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_EEVEE_STARTER, TYPE_NORMAL, ABILITY_EVO_WISH},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_FLAREON, TYPE_FIRE, ABILITY_EVO_WISH},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_VAPOREON, TYPE_WATER, ABILITY_EVO_WISH},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_JOLTEON, TYPE_ELECTRIC, ABILITY_EVO_WISH},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_ESPEON, TYPE_PSYCHIC, ABILITY_EVO_WISH},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_UMBREON, TYPE_DARK, ABILITY_EVO_WISH},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_LEAFEON, TYPE_GRASS, ABILITY_EVO_WISH},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_GLACEON, TYPE_ICE, ABILITY_EVO_WISH},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_SYLVEON, TYPE_FAIRY, ABILITY_EVO_WISH},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_ROCHEON, TYPE_ROCK, ABILITY_EVO_WISH},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_DRACEON, TYPE_DRAGON, ABILITY_EVO_WISH},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_FERREON, TYPE_STEEL, ABILITY_EVO_WISH},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_STRIKEON, TYPE_FIGHTING, ABILITY_EVO_WISH},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_NOXEON, TYPE_POISON, ABILITY_EVO_WISH},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_TERREON, TYPE_GROUND, ABILITY_EVO_WISH},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_GRUBBEON, TYPE_BUG, ABILITY_EVO_WISH},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_SPOOKEON, TYPE_GHOST, ABILITY_EVO_WISH},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_EEVEE_GMAX, TYPE_FLYING, ABILITY_EVO_WISH},
    //{FORM_CHANGE_BATTLE_SWITCH, SPECIES_EEVEE_STARTER},
    {FORM_CHANGE_FAINT, SPECIES_EEVEE_STARTER},
...
static const struct FormChange sCastformFormChangeTable[] =
{
    ...
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_CASTFORM_SANDY,  WEATHER_SANDSTORM},
