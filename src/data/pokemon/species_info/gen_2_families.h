...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_CHIKORITA] =
    {
        ...
        .abilities = { ABILITY_STATIC, ABILITY_LEAF_GUARD, ABILITY_ELECTRIC_SURGE },
    ...
    [SPECIES_TOTODILE] =
    {
        ...
        .abilities = { ABILITY_STEADFAST, ABILITY_SWIFT_SWIM, ABILITY_SHEER_FORCE },
    ...
    [SPECIES_HOOTHOOT] =
    {
        ...
        .abilities = { ABILITY_TINTED_LENS, ABILITY_KEEN_EYE, ABILITY_SNOW_WARNING },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LEDYBA] =
    {
        ...
        .abilities = { ABILITY_RATTLED, ABILITY_IRON_FIST, ABILITY_WIND_RIDER },
    ...
    [SPECIES_SPINARAK] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SNIPER, ABILITY_POISON_TOUCH, ABILITY_TOXIC_BOOST },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_CHINCHOU] =
    {
        ...
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_ILLUMINATE, ABILITY_DISGUISE },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 49, SPECIES_LANTURN}),
    },
...
#define TOGEPI_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_SUNKERN] =
    {
        ...
        .abilities = { ABILITY_NATURAL_CURE, ABILITY_SOLAR_POWER, ABILITY_EARLY_BIRD },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_SUNFLORA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_NATURAL_CURE, ABILITY_SOLAR_POWER, ABILITY_DROUGHT },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_MISDREAVUS] =
    {
        ...
        .abilities = { ABILITY_LEVITATE, ABILITY_SYNCHRONIZE, ABILITY_POWER_OF_ALCHEMY },
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_GLIGAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_HYPER_CUTTER, ABILITY_OVERCOAT, ABILITY_IMMUNITY },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_GLISCOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_HYPER_CUTTER, ABILITY_OVERCOAT, ABILITY_POISON_HEAL },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_GRANBULL] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_GUARD_DOG, ABILITY_STRONG_JAW },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_QWILFISH_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_IRON_BARBS, ABILITY_AFTERMATH, ABILITY_UNAWARE },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
        .speciesName = _("Qwilfish"),
        .cryId = CRY_QWILFISH,
        ...
        .formSpeciesIdTable = sQwilfishFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_OVERQWIL, CONDITIONS({IF_KNOWS_MOVE, MOVE_EXPLOSION})}),
    },
    ...
    [SPECIES_HERACROSS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SKILL_LINK, ABILITY_SWARM, ABILITY_MOXIE },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_HERACROSS_MEGA}),
    },
    ...
    [SPECIES_SLUGMA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_MAGMA_ARMOR, ABILITY_FLASH_FIRE, ABILITY_MIRROR_ARMOR },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_SWINUB] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_CURSED_BODY, ABILITY_THICK_FAT },
    #else
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_MAMOSWINE, CONDITIONS({IF_KNOWS_MOVE, MOVE_GRUDGE})},
                                {EVO_LEVEL, 0, SPECIES_MAMOSWINE, CONDITIONS({IF_KNOWS_MOVE, MOVE_CURSE})}),
    #endif
    },
    ...
    [SPECIES_CORSOLA_GALAR] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_3),
        .abilities = { ABILITY_REGENERATOR, ABILITY_NATURAL_CURE, ABILITY_PSYCHIC_SURGE },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Corsola"),
        .cryId = CRY_CORSOLA,
        .natDexNum = NATIONAL_DEX_CORSOLA,
    ...
    [SPECIES_REMORAID] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_OCTILLERY}),
    },
    ...
    [SPECIES_OCTILLERY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_2),
        .abilities = { ABILITY_SUCTION_CUPS, ABILITY_SNIPER, ABILITY_SKILL_LINK },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_MANTYKE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_WIND_POWER, ABILITY_SURGE_SURFER, ABILITY_SWIFT_SWIM },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_PHANPY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PICKUP, ABILITY_OWN_TEMPO, ABILITY_HUSTLE },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_DONPHAN}),
    },
    ...
    [SPECIES_DONPHAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STURDY, ABILITY_VITAL_SPIRIT, ABILITY_RECKLESS },
        .bodyColor = BODY_COLOR_GRAY,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_GREAT_TUSK, CONDITIONS({IF_RECOIL_DAMAGE_GE, 294})},
                                {EVO_LEVEL, 0, SPECIES_IRON_TREADS, CONDITIONS({IF_USED_MOVE_X_TIMES, MOVE_ROLLOUT, 20})}),
    },
    ...
    [SPECIES_LARVITAR] =
    {
        ...
        .abilities = { ABILITY_RIVALRY, ABILITY_GUTS, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_PUPITAR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_RIVALRY, ABILITY_SHED_SKIN, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_GRAY,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 55, SPECIES_TYRANITAR, CONDITIONS({IF_ATK_LT_DEF})},
                                {EVO_LEVEL, 55, SPECIES_IRON_THORNS, CONDITIONS({IF_ATK_EQ_DEF})}),
    ...
    [SPECIES_TYRANITAR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_STURDY, ABILITY_MOLD_BREAKER, ABILITY_MAGNET_PULL },
        .bodyColor = BODY_COLOR_GREEN,
