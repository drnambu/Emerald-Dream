...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_POPPLIO] =
    {
        ...
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_WATER_ABSORB, ABILITY_DAZZLING },
    ...
    [SPECIES_ROCKRUFF] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_LYCANROC_MIDDAY, CONDITIONS({IF_NOT_TIME, TIME_NIGHT})},
                                {EVO_LEVEL, 30, SPECIES_LYCANROC_MIDNIGHT, CONDITIONS({IF_TIME, TIME_NIGHT})}),
    },
    ...
    [SPECIES_ROCKRUFF_OWN_TEMPO] =
    {
        ...
        .eggMoveLearnset = sRockruffEggMoveLearnset,
        .formSpeciesIdTable = sRockruffFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_LYCANROC_DUSK, CONDITIONS({IF_TIME, TIME_EVENING})}),
    },
    ...
    [SPECIES_LYCANROC_MIDDAY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STEADFAST, ABILITY_STAKEOUT, ABILITY_SAND_RUSH },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LYCANROC_MIDNIGHT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_MINDS_EYE, ABILITY_INNER_FOCUS, ABILITY_GUTS },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Lycanroc"),
    ...
    [SPECIES_LYCANROC_DUSK] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SAND_RUSH, ABILITY_ROCK_HEAD, ABILITY_GUARD_DOG },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Lycanroc"),
    ...
    [SPECIES_MAREANIE] =
    {
        ...
        .abilities = { ABILITY_CORROSION, ABILITY_CURSED_BODY, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_DEWPIDER] =
    {
        ...
        .abilities = { ABILITY_SWARM, ABILITY_COMPOUND_EYES, ABILITY_AIR_BUBBLE },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_MORELULL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_ANALYTIC, ABILITY_EFFECT_SPORE, ABILITY_SNOW_WARNING },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_BOUNSWEET] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_GUTS, ABILITY_QUEENLY_MAJESTY, ABILITY_LEAF_GUARD },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_STEENEE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_GUTS, ABILITY_QUEENLY_MAJESTY, ABILITY_VERDANT_DASH },
        .bodyColor = BODY_COLOR_PURPLE,
        .noFlip = TRUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_TSAREENA}),
    },
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal, heldItem)\
    ...
    [SPECIES_DHELMISE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_HEAVY_METAL, ABILITY_LEAF_GUARD, ABILITY_STEELWORKER },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
