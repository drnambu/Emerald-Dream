...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_PIPLUP] =
    {
        ...
        .abilities = { ABILITY_TANGLED_FEET, ABILITY_SLUSH_RUSH, ABILITY_COMPETITIVE },
    #else
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 24, SPECIES_PRINPLUP}),
    },
    ...
    [SPECIES_PRINPLUP] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 48, SPECIES_EMPOLEON}),
    },
    ...
    [SPECIES_SHINX] =
    {
        ...
        .abilities = { ABILITY_FRISK, ABILITY_RUN_AWAY, ABILITY_RIVALRY },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Shinx"),
        .cryId = CRY_SHINX,
    ...
    [SPECIES_LUXIO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = {  ABILITY_STAKEOUT, ABILITY_RATTLED, ABILITY_INTIMIDATE  },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Luxio"),
        .cryId = CRY_LUXIO,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_COMBEE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_HONEY_GATHER, ABILITY_SWEET_VEIL, ABILITY_HUSTLE },
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_VESPIQUEN, CONDITIONS({IF_GENDER, MON_FEMALE})},
                                {EVO_LEVEL, 25, SPECIES_COMBICADE, CONDITIONS({IF_GENDER, MON_MALE})}),
    },
    ...
    [SPECIES_VESPIQUEN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_LEVITATE, ABILITY_QUEENLY_MAJESTY, ABILITY_QUEEN_OF_BUGS },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_COMBICADE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_AROMA_VEIL, ABILITY_SWEET_VEIL, ABILITY_FILTER },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Combee"),
        .cryId = CRY_COMBEE,
        .natDexNum = NATIONAL_DEX_COMBICADE,
        .categoryName = _("Tiny Bee"),
        .height = 4.5,
        .weight = 165,
        .description = COMPOUND_STRING(
        ...
        .frontAnimId = ANIM_V_SLIDE_WOBBLE,
        .enemyMonElevation = 15,
        .backPic = gMonBackPic_Combicade,
        .backPicSize = MON_COORDS_SIZE(64, 48),
        .backPicYOffset = 22,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        .palette = gMonPalette_Combicade,
        .shinyPalette = gMonShinyPalette_Combicade,
        .iconSprite = gMonIcon_Combicade,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-4, 10, SHADOW_SIZE_S)
        FOOTPRINT(Combee)
    ...
    [SPECIES_BUIZEL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_SURGE_SURFER, ABILITY_PROPELLER_TAIL },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SHELLOS_WEST] =
    {
        ...
        .abilities = { ABILITY_SAND_FORCE, ABILITY_ICE_BODY, ABILITY_GOOEY },
        .bodyColor = BODY_COLOR_PURPLE,
        ...
        .levelUpLearnset = sShellosWestLevelUpLearnset,
        .teachableLearnset = sShellosWestTeachableLearnset,
    ...
    [SPECIES_SHELLOS_EAST] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_SAND_FORCE, ABILITY_FLAME_BODY, ABILITY_GOOEY },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Shellos"),
        .cryId = CRY_SHELLOS,
        .natDexNum = NATIONAL_DEX_SHELLOS,
        ...
        .levelUpLearnset = sShellosEastLevelUpLearnset,
        .teachableLearnset = sShellosEastTeachableLearnset,
        .eggMoveLearnset = sShellosEggMoveLearnset,
        .formSpeciesIdTable = sShellosFormSpeciesIdTable,
    ...
    [SPECIES_GASTRODON_WEST] =
    {
        ...
        .levelUpLearnset = sGastrodonWestLevelUpLearnset,
        .teachableLearnset = sGastrodonWestTeachableLearnset,
    ...
    [SPECIES_GASTRODON_EAST] =
    {
        ...
        .levelUpLearnset = sGastrodonEastLevelUpLearnset,
        .teachableLearnset = sGastrodonEastTeachableLearnset,
        .formSpeciesIdTable = sGastrodonFormSpeciesIdTable,
    },
    ...
    [SPECIES_DRIFLOON] =
    {
        ...
        .abilities = { ABILITY_AFTERMATH, ABILITY_UNBURDEN, ABILITY_SOLAR_POWER },
        .bodyColor = BODY_COLOR_PURPLE,
        .noFlip = TRUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 44, SPECIES_DRIFBLIM, CONDITIONS({IF_TYPE_IN_PARTY, TYPE_FIRE})}),
    },
    ...
    [SPECIES_GLAMEOW] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_KLUTZ, ABILITY_FLUFFY, ABILITY_QUEENLY_MAJESTY },
        .bodyColor = BODY_COLOR_GRAY,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_PURUGLY}),
    },
    ...
    [SPECIES_PURUGLY] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STENCH, ABILITY_COTTON_DOWN, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_BRONZOR] =
    {
        ...
        .abilities = { ABILITY_LEVITATE, ABILITY_MAGIC_GUARD, ABILITY_SAND_STREAM },
        .bodyColor = BODY_COLOR_GREEN,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 38, SPECIES_BRONZONG}),
    },
    ...
    [SPECIES_SPIRITOMB] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_PRESSURE, ABILITY_STATIC, ABILITY_WANDERING_SPIRIT },
        .bodyColor = BODY_COLOR_PURPLE,
        .noFlip = TRUE,
    ...
    [SPECIES_RIOLU] =
    {
        ...
        .abilities = { ABILITY_TELEPATHY, ABILITY_INNER_FOCUS, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Riolu"),
        .cryId = CRY_RIOLU,
    ...
    [SPECIES_LUCARIO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_TELEPATHY, ABILITY_INNER_FOCUS, ABILITY_JUSTIFIED },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_HIPPOPOTAS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_DRIZZLE, ABILITY_NONE, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_CROAGUNK] =
    {
        ...
        .abilities = { ABILITY_POISON_TOUCH, ABILITY_FLASH_FIRE, ABILITY_DRY_SKIN },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_CARNIVINE] =
    {
        ...
        .abilities = { ABILITY_LEVITATE, ABILITY_UNNERVE, ABILITY_ARENA_TRAP },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
    ...
    [SPECIES_FINNEON] =
    {
        ...
        .abilities = { ABILITY_POISON_TOUCH, ABILITY_STORM_DRAIN, ABILITY_SWIFT_SWIM },
        .bodyColor = BODY_COLOR_BLUE,
