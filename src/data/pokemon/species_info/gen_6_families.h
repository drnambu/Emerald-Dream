...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_FENNEKIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_MAGIC_GUARD, ABILITY_TELEPATHY, ABILITY_MAGICIAN },
    ...
    [SPECIES_FROAKIE] =
    {
        ...
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_DRY_SKIN, ABILITY_TECHNICIAN },
...
#define VIVILLON_MISC_INFO(form, color, iconPal)                                            \
    ...
    [SPECIES_LITLEO] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 38, SPECIES_PYROAR}),
    },
    ...
    [SPECIES_PYROAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_COMPETITIVE, ABILITY_UNNERVE, ABILITY_STAKEOUT },
        .bodyColor = BODY_COLOR_BROWN,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_SPRITZEE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities = { ABILITY_HEALER, ABILITY_AROMA_VEIL, ABILITY_CURSED_BODY },
    ...
    [SPECIES_SKRELP] =
    {
        ...
        .abilities = { ABILITY_LEAF_GUARD, ABILITY_SWIFT_SWIM, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_CLAUNCHER] =
    {
        ...
        .abilities = { ABILITY_MEGA_LAUNCHER, ABILITY_SCRAPPY, ABILITY_WEAK_ARMOR },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 47, SPECIES_CLAWITZER}),
    },
    ...
    [SPECIES_HELIOPTILE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_FIRE_STONE, SPECIES_HELIOLISK}),
    },
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 38, SPECIES_SLIGGOO, CONDITIONS({IF_NOT_REGION, REGION_HISUI})},
    ...
    [SPECIES_PUMPKABOO_AVERAGE] =
    {
       ...
       .abilities = { ABILITY_LEVITATE, ABILITY_LEAF_GUARD, ABILITY_UNAWARE },
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 44, SPECIES_GOURGEIST_AVERAGE}),
    },
    ...
    [SPECIES_PUMPKABOO_SMALL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_MAGIC_BOUNCE, ABILITY_LEVITATE, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Pumpkaboo"),
        .cryId = CRY_PUMPKABOO,
        .natDexNum = NATIONAL_DEX_PUMPKABOO,
        ...
        .eggMoveLearnset = sPumpkabooEggMoveLearnset,
        .formSpeciesIdTable = sPumpkabooFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 44, SPECIES_GOURGEIST_SMALL}),
    },
    ...
    [SPECIES_PUMPKABOO_LARGE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_RIPEN, ABILITY_MAGIC_BOUNCE, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Pumpkaboo"),
        .cryId = CRY_PUMPKABOO,
        .natDexNum = NATIONAL_DEX_PUMPKABOO,
        ...
        .eggMoveLearnset = sPumpkabooEggMoveLearnset,
        .formSpeciesIdTable = sPumpkabooFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 44, SPECIES_GOURGEIST_LARGE}),
    },
    ...
    [SPECIES_PUMPKABOO_SUPER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_RIPEN, ABILITY_LEAF_GUARD, ABILITY_UNAWARE },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Pumpkaboo"),
        ...
        .eggMoveLearnset = sPumpkabooEggMoveLearnset,
        .formSpeciesIdTable = sPumpkabooFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 44, SPECIES_GOURGEIST_SUPER}),
    },
    ...
    [SPECIES_GOURGEIST_SMALL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_LEVITATE, ABILITY_MAGIC_BOUNCE, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Gourgeist"),
        .cryId = CRY_GOURGEIST,
        .natDexNum = NATIONAL_DEX_GOURGEIST,
